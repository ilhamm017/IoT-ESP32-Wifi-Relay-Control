...
Kontrol hingga 8 relay via web browser menggunakan ESP32. Mendukung scan WiFi, konfigurasi IP static (dengan subnet & DNS), Basic Auth, dan halaman konfigurasi yang tetap bisa diakses saat sudah terhubung.

## Key Features

- Kontrol hingga 8 relay via HTTP (tanpa autentikasi)
...
| `/1..8/on` | GET | Relay ON (1..8) |
| `/1..8/off` | GET | Relay OFF (1..8) |
| `/1..8/status` | GET | Status relay (1..8) |
